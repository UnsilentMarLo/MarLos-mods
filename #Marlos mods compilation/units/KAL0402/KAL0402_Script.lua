...
local ColossusLaser = import('/mods/#Marlos mods compilation/lua/MKWeapons.lua').ColossusLaser
...
UAL0401 = Class(AWalkingLandUnit) {
    ...
    DeathThread = function(self, overkillRatio , instigator)
        ...
        explosion.CreateDefaultHitExplosionAtBone(self, 'Turret', 4.0)
        explosion.CreateDebrisProjectiles(self, explosion.GetAverageBoundingXYZRadius(self), {self:GetUnitSizes()})
        WaitSeconds(2)
        explosion.CreateDefaultHitExplosionAtBone(self, 'Leg03_B03_02', 1.0)
        WaitSeconds(0.1)
        explosion.CreateDefaultHitExplosionAtBone(self, 'Leg02_B03_02', 1.0)
        WaitSeconds(0.1)
        explosion.CreateDefaultHitExplosionAtBone(self, 'Turret_Panel02', 1.0)
        WaitSeconds(0.3)
        explosion.CreateDefaultHitExplosionAtBone(self, 'Leg02_B03_02', 1.0)
        explosion.CreateDefaultHitExplosionAtBone(self, 'Leg03_B03_02', 1.0)
