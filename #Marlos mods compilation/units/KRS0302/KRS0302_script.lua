...
URS0201 = Class(CSeaUnit) {
    ...
    Weapons = {
        FrontTurret01 = Class(CDFProtonCannonWeapon) {},
        FrontTurret02 = Class(CDFProtonCannonWeapon) {},
        FrontTurret03 = Class(CDFProtonCannonWeapon) {},
        FrontTurret04 = Class(CDFProtonCannonWeapon) {},
    ...
    TransformThread = function(self, land)
        ...
        if land then
            ...
            self:SetCollisionShape('Box', bp.CollisionOffsetX or 0, (bp.CollisionOffsetY + (bp.SizeY * 1.4)) or 0, bp.CollisionOffsetZ or 0, bp.SizeX * (scale - 0.2), bp.SizeY * (scale - 0.2), bp.SizeZ * (scale - 0.35))
