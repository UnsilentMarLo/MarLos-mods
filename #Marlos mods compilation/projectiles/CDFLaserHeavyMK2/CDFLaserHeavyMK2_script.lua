...
# Cybran laser 'bolt'
#
local CHeavyLaserProjectileMK2 = import('/Mods/#Marlos mods compilation/lua/MKProjectiles.lua').CHeavyLaserProjectileMK2
local RandomFloat = import('/lua/utilities.lua').GetRandomFloat
CDFLaserHeavy01 = Class(CHeavyLaserProjectileMK2) {
    ...
    OnImpact = function(self, TargetType, targetEntity)
		...
		CHeavyLaserProjectileMK2.OnImpact( self, TargetType, targetEntity )
    end,	
