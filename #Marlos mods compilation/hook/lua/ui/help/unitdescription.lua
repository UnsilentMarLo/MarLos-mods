...
----UEF Units
   ...
   ----Commanders
    ['kel0407-tm'] = "Adds a tactical missile volley launcher on both sides of the turret.",
    ['kel0407-dsu'] = "Adds 2 Weapons onto the turret.",
    ['kel0407-hamc'] = "this upgrade allows the main gun to use more propellant and explosives.",
